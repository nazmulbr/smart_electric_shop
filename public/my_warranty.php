    ...
    <div class="container mt-4">
        ...
        <?php if($warranty):?>
            <table class="table table-bordered bg-white col-md-6">
                <tr><th>Duration (months)</th><td><?=htmlspecialchars($warranty['warranty_duration'])?></td></tr>
                <tr><th>Purchase Date</th><td><?=htmlspecialchars($warranty['purchase_date'])?></td></tr>
                <tr><th>Expiry Date</th><td><?=htmlspecialchars($expiry)?></td></tr>
            </table>
