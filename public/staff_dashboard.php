...
<body>
    ...
    <div class="container dashboard-section">
        <div class="dashboard-header d-flex justify-content-between align-items-center">
            ...
            <a href="manage_contacts.php" class="btn btn-outline-light">Manage Contacts</a>
        </div>
        ...
        <div class="dashboard-grid">
            ...
            <a class="dashboard-card" href="manage_contacts.php">
                <div class="dashboard-icon"><i class="fas fa-comments"></i></div>
                <div class="dashboard-card-title">Manage Contacts</div>
                <div class="dashboard-card-desc">Respond to user messages</div>
            </a>
        </div>
